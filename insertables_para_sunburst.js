...
<div id="quitame" style="height: 100%; width: 100%">
    <div style="position: absolute; width: 33vw; top: 40px; left: 0;">
    <h2 id="barrio-h" style="font-size: 3rem;">¿ Qué piensan los ciudadanos de: <span id="titulo-villa" style="color:#f48633;">Villavicencio </span>?</h2>
</div>
            ...
            setTimeout(function () {
              ...
              `);
                ...
                $('#btn-filtrar').click(function(c){
                    ...
                    postData(urlBack+'sunburst', {"respuesta":preguntas, "sexos":sexos, "edades": edades}).then(data => {
                        data.name = "ODS";
