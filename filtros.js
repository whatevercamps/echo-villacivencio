...
male ? sexos.push("masculino") : "";
female ? sexos.push("femenino") : "";
...
var numero = 40;
var req = { sexos: sexos, edades: edades};
...
function click_filtro(command) {
    ...
    req_sun_inic.respuesta = preguntas;
    console.log(req_sun_inic, "aqui")
